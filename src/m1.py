...
class CircleChanger(object):
    ...
    def __init__(self, x, y, radius, fill_color, colors):
        ...
        self.seconds_to_sleep = 0.1  # Default for each call to draw
        # --------------------------------------------------------------
    ...
    def swell_or_shrink_once(self, amount_to_swell_or_shrink):
        ...
        t = random.randrange(3, 16)
        self.circle.outline_thickness = t
        c = random.randrange(0, len(self.colors))
        self.circle.fill_color = self.colors[c]
    ...
    def swallow(self, other_circle_changer):
        ...
        center = rg.Point(((self.circle.center.x + other_circle_changer.circle.center.x) / 2), (self.circle.center.y + other_circle_changer.circle.center.y) / 2)
